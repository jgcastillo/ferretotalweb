...
@NamedQueries({
    ...
    @NamedQuery(name = "Tiempo.findByCerrarLlamada", query = "SELECT t FROM Tiempo t WHERE t.cerrarLlamada = :cerrarLlamada"),
...
public class Tiempo implements Serializable {
    ...
    public Tiempo(Integer id, int atencionBuena, int atencionRegular, int cerrarLlamada, int status) {
        this.id = id;
    ...
    public String toString() {
        return "com.ferretotal.serialservice.entity.Tiempo[ id=" + id + " ]";
    }
