...
import com.ferretotal.serialservice.controller.ConexionBaseDatosController;
import com.ferretotal.serialservice.controller.TurnoJpaController;
import com.ferretotal.serialservice.controller.extensions.BotonJpaControllerExt;
import com.ferretotal.serialservice.controller.extensions.DistribucionJpaControllerExt;
import com.ferretotal.serialservice.controller.extensions.LlamadaJpaControllerExt;
 ...
 * @author jgcastillo
 */
public class SerialService implements SerialPortEventListener, ActionListener {
    ...
    private LlamadaJpaControllerExt llamadaController;
    private TurnoJpaController turnoController;
    private ConexionBaseDatosController controller;
    ...
    public SerialService() {
        controller = new ConexionBaseDatosController();
        botonController = new BotonJpaControllerExt(JpaUtilities.getEntityManagerFactory());
        llamadaController = new LlamadaJpaControllerExt(JpaUtilities.getEntityManagerFactory());
        distController = new DistribucionJpaControllerExt(JpaUtilities.getEntityManagerFactory());
        turnoController = new TurnoJpaController(JpaUtilities.getEntityManagerFactory());
        //startClock();
        chequeos();
    }
...
//                break;
    ...
    /**
     * Es el método que escucha los eventos que son disparados por el Timer
     * según el tiempo colocado en el método startClock
     *
     * @param e
     */
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(timer)) {
            ...
            for (Turno turno : turnos) {
                if (!isFeriado && turno.getFeriado() == GeneralUtilities.NORMAL) {
                    ...
                    if (turno.getFeriado() == GeneralUtilities.FERIADO) {
                        calTurnoStart.setTime(turno.getHoraStart());
                        calTurnoEnd.setTime(turno.getHoraEnd());
    ...
    private void chequeaTurno() {
        ...
        for (Turno turno : turnos) {
            if (!isFeriado && (turno.getFeriado() == GeneralUtilities.NORMAL)) {
                ...
                if (isFeriado && (turno.getFeriado() == GeneralUtilities.FERIADO)) {
                    calTurnoStart.setTime(turno.getHoraStart());
                    calTurnoEnd.setTime(turno.getHoraEnd());
