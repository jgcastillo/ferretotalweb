...
public class LlamadaServiceManager implements Serializable {
    ...
    /**
     * M̩todo para obtener la surursal de una tienda de una llamada dada
     *
     * @param llamada
    ...
    /**
     * M̩todo para retornar el nombre turno de una llamada dada
     *
     * @param ll
    ...
    /**
     * M̩todo para obtener el valor del valor feriado de una llamada dada
     *
     * @param llamada
    ...
    /**
     * M̩todo que retorna la calidad de una llamada dada (buena, regular, mala,
     * automatica)
     *
     * @param llamada
